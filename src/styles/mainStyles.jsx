...
export const styles = StyleSheet.create({
    ...
    // Una chiave nelle impostazioni: cosa fa, da dove viene, e un campo per
    // metterne una propria. Il valore non si mostra mai.
    chiaveRiga: {
        marginTop: 14,
        marginBottom: 4,
        paddingTop: 12,
        borderTopWidth: 1,
        borderTopColor: 'rgba(0, 217, 255, 0.12)',
    },
    chiaveIntestazione: {
        flexDirection: 'row',
        alignItems: 'baseline',
    ...
    // Il primo avvio: una schermata sola, un campo solo.
    benvenutoSchermo: {
        flex: 1,
        backgroundColor: BG,
        alignItems: 'center',
    ...
    // Il tasto per allegare, gemello dell'invio ma dall'altra parte del campo.
    attachButton: {
        marginRight: 10,
        width: 48,
        height: 48,
    ...
    // L'immagine agganciata, sopra il campo: si vede cosa sta per partire.
    allegatoRiga: {
        flexDirection: 'row',
        alignItems: 'center',
        width: '100%',
