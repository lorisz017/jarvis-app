...
export const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingRight: 108, // lascia spazio ai due pulsanti ancorati in alto a destra
        marginBottom: 18,
    },
    headerTitleBlock: {
        flexShrink: 1,
    ...
    // Riga di pulsanti compatti in fondo, al posto dei vecchi bottoni
    // rettangolari impilati a tutta larghezza
    actionRow: {
        flexDirection: 'row',
        width: '100%',
        maxWidth: 380,
